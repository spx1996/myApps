...
let setWatermark = (str, currentId) => {
  ...
  console.log("document.getElementById(currentId)---->",document.getElementById(currentId).clientWidth)
  div.style.width = document.getElementById(currentId).clientWidth + 'px';
  div.style.height = document.getElementById(currentId).clientHeight + 'px';
